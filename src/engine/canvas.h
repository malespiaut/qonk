...
class Canvas
{
  public:
    ...
    static void drawMouseSelection(Coordinate &, Coordinate &);

    static void drawCursor(Coordinate &);

    static void updateScreen();

    static void initScreen(int, int, bool);
  ...
  private:
    ...
    static int width, height, gameOffsetX;
